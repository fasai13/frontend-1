      ...
      <div className="row align-items-center mb-5">
        ...
        <div className="col-lg-7">
          <div className="p-4 rounded-4 shadow-sm">
            <h1 className="display-5 fw-bold mb-2" style={{ color: '#ff85a2' }}>{personalInfo.name}</h1>
          ...
          <ul className="nav nav-pills nav-fill">
            ...
            <li className="nav-item">
              <button 
                ...
                style={{ 
                  background: activeTab === 'skills' ? '#7ec4cf' : 'transparent',
            ...
            <li className="nav-item">
              <button 
                ...
                style={{ 
                  background: activeTab === 'experience' ? '#b892ff' : 'transparent',
                  ...
                  <div className="col-md-6 mb-4">
                    <div className="card border-0 shadow-sm h-100">
                      <div className="card-body">
                        <h5 className="card-title mb-3">จุดเริ่มต้นของการเดินทาง</h5>
                        <p className="card-text">
                          ความหลงใหลในการท่องเที่ยวของฉันเริ่มต้นตั้งแต่วัยเด็ก เมื่อครอบครัวพาไปเที่ยวตามจังหวัดต่างๆ ทั่วประเทศไทย 
                          จากนั้นฉันได้ศึกษาด้านการท่องเที่ยวอย่างจริงจัง และค้นพบว่านี่คือเส้นทางที่ฉันต้องการจะเดิน
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 mb-4">
                    <div className="card border-0 shadow-sm h-100">
                      <div className="card-body">
                        ...
                        <p className="card-text">
                          แรงบันดาลใจของฉันมาจากวัฒนธรรมท้องถิ่นและธรรมชาติอันงดงามของประเทศไทย ฉันชอบค้นหาสถานที่ท่องเที่ยวที่ยังไม่เป็นที่รู้จักมากนัก 
                  ...
                  <div className="col-12 mb-4">
                    <div className="card border-0 shadow-sm">
                      <div className="card-body">
                        ...
                        <p className="card-text">
                          ฉันเชื่อว่าการท่องเที่ยวควรเป็นมากกว่าแค่การถ่ายรูปสวยๆ แต่เป็นการเรียนรู้วัฒนธรรม ผู้คน และวิถีชีวิตท้องถิ่น 
                          ฉันมุ่งมั่นที่จะส่งเสริมการท่องเที่ยวอย่างยั่งยืนที่เคารพธรรมชาติและชุมชนท้องถิ่น ทุกทริปของฉันออกแบบด้วยความใส่ใจในรายละเอียดและคำนึงถึงผลกระทบต่อสิ่งแวดล้อม
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-12 mb-4">
                    <div className="card border-0 shadow-sm">
                      <div className="card-body text-center p-4">
                        <h5 className="card-title mb-3">สถานที่ท่องเที่ยวที่ประทับใจ</h5>
                        <div className="row">
              ...
              <div className="experience-content">
                        ...
                        <div className="mt-3">
                          ...
                          <ul className="list-unstyled">
                            <li className="mb-2 d-flex align-items-center">
                              ...
                              {index === 0 ? "พัฒนาทัวร์ 'Hidden Thailand' ที่นำเสนอสถานที่ท่องเที่ยวที่ยังไม่เป็นที่รู้จักมากนัก" : "มีส่วนร่วมในการพัฒนาเส้นทางท่องเที่ยวเชิงวัฒนธรรมที่ได้รับความนิยมสูงสุดของบริษัท"}
                            </li>
                            <li className="mb-2 d-flex align-items-center">
                              <i className="bi bi-check-circle-fill me-2" style={{ color: '#b892ff' }}></i>
                              {index === 0 ? "สร้างเครือข่ายกับชุมชนท้องถิ่นเพื่อนำเสนอประสบการณ์ท่องเที่ยวที่แท้จริง" : "พัฒนาระบบการประเมินความพึงพอใจของลูกค้าที่ช่วยปรับปรุงคุณภาพการบริการ"}
                            </li>
                          </ul>
                        </div>
                      </div>
                ...
                <div className="card border-0 shadow-sm">
                  <div className="card-body p-4 text-center">
                    ...
                    <p className="card-text">
                      ฉันตั้งใจที่จะขยายธุรกิจนำเที่ยวให้ครอบคลุมภูมิภาคอาเซียน และมุ่งมั่นที่จะส่งเสริมการท่องเที่ยวอย่างยั่งยืน 100% 
      ...
      <div className="row mt-5">
        <div className="col-12 text-center">
          <div className="p-4 rounded-4 shadow-sm" style={{ background: 'rgba(255, 133, 162, 0.1)' }}>
            <h3 className="mb-3" style={{ color: '#ff85a2' }}>สนใจเดินทางกับฉัน</h3>
            <p className="mb-4">หากคุณสนใจเดินทางท่องเที่ยวหรือมีคำถามเกี่ยวกับสถานที่ท่องเที่ยว สามารถติดต่อได้ตามช่องทางด้านล่าง</p>
