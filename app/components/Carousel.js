    ...
    >
        ...
        >
          <div
            style={{
              width: "30px",
              height: "30px",
              background: "rgba(126, 196, 207, 0.7)",
              borderRadius: "50%",
              backdropFilter: "blur(5px)",
            }}
          ></div>
        ...
        >
          <div
            style={{
              width: "20px",
              height: "20px",
              background: "rgba(184, 146, 255, 0.7)",
              borderRadius: "50%",
              backdropFilter: "blur(5px)",
            }}
          ></div>
      ...
      >
        ...
        <div
          ...
          style={{ bottom: isMobile ? "10px" : "20px" }}
        >
          {[0, 1, 2].map((index) => (
            <button
              key={index}
